...
namespace WheelRecognitionSystem.Public
{
    public  class HDevelopExport
    {
            ...
            HTuple hv_KeysForDisplay, HTuple hv_GenParam, HTuple hv_WindowHandleDict)
        {
            ...
            HTuple hv_MaxClassId = new HTuple(), hv_ClassIDs = new HTuple();
            HTuple hv_ClassNames = new HTuple(), hv_ClassNameKey = new HTuple();
            ...
            HTuple hv_AnomalyImages = new HTuple(), hv_PossibleKeysForDisplay = new HTuple();
            HTuple hv_AddDisplayKey = new HTuple(), hv_AnomalyLabelGroundTruth = new HTuple();
            HTuple hv_AnomalyLabelIDGroundTruth = new HTuple(), hv_AnomalyResultPostfix = new HTuple();
            ...
            HTuple hv_AnomalyRegionKey = new HTuple(), hv_BboxLabelIndex = new HTuple();
            HTuple hv_BboxConfidences = new HTuple(), hv_TextConf = new HTuple();
            HTuple hv_BboxClassIndex = new HTuple(), hv_BboxColorsBoth = new HTuple();
            HTuple hv_BboxClassLabelIndexUniq = new HTuple(), hv_BboxIDs = new HTuple();
            ...
            HTuple hv_BoarderOffset = new HTuple(), hv_WindowImageRatioHeight = new HTuple();
            HTuple hv_WindowImageRatioWidth = new HTuple(), hv_BoarderOffsetRow = new HTuple();
            HTuple hv_BoarderOffsetCol = new HTuple(), hv_MarginBottom = new HTuple();
            ...
            HTuple hv_Indices = new HTuple(), hv_WindowHandleKeysNew = new HTuple();
            ...
            try
            {
                ...
                if ((int)(new HTuple(hv_GenParam.TupleNotEqual(new HTuple()))) != 0)
                {
                        ...
                        )) - 1); hv_ParamIndex = (int)hv_ParamIndex + 1)
                    {
                        ...
                        if ((int)(new HTuple(hv_GenParamName.TupleEqual("anomaly_classification_threshold"))) != 0)
                        {
                            hv_AnomalyClassificationThreshold.Dispose();
                        ...
                        else if ((int)(new HTuple(hv_GenParamName.TupleEqual("threshold_width"))) != 0)
                        {
                            hv_ThresholdWidth.Dispose();
                ...
                if ((int)((new HTuple((new HTuple(hv_DLSample.TupleLength())).TupleGreater(
                    1))).TupleOr(new HTuple((new HTuple(hv_DLResult.TupleLength())).TupleGreater(
                    1)))) != 0)
                {
                ...
                if ((int)(new HTuple(hv_DLDatasetInfo.TupleEqual(new HTuple()))) != 0)
                {
                    ...
                    dev_display_dl_data_get_max_class_id(hv_DLResult, out hv_MaxClassIdResult,
                        out hv_EmptyResult);
                    ...
                    if ((int)(new HTuple(hv_DLResult.TupleNotEqual(new HTuple()))) != 0)
                    {
                            ...
                            1)))) != 0)
                        {
                            ...
                            HOperatorSet.GetDictTuple(hv_DLResult, hv_ClassNameKey, out hv_ResultClassNames);
                            hv_ResultClassIds.Dispose();
                            HOperatorSet.GetDictTuple(hv_DLResult, hv_ClassIdKey, out hv_ResultClassIds);
                    ...
                    )))) != 0)
                {
                        ...
                        hv_KeyIndex))).TupleEqual("anomaly_both_global")))) != 0)
                    {
                        ...
                        get_anomaly_result(out ho_AnomalyImage, out ho_AnomalyRegion, hv_DLResult,
                            hv_AnomalyClassificationThreshold, hv_AnomalyRegionThreshold, hv_AnomalyResultPostfix,
                        ...
                        hv_CurrentWindowHandle.Dispose(); hv_WindowImageRatio.Dispose();
                        {
                            HTuple ExpTmpOutVar_0;
                            get_next_window(hv_Font, hv_FontSize, hv_ShowBottomDesc, hv_WidthImage,
                                hv_HeightImage, 0, hv_ScaleWindows, hv_ThresholdWidth, hv_PrevWindowCoordinates,
                                hv_WindowHandleDict, hv_WindowHandleName, out hv_CurrentWindowHandle,
                        ...
                        if ((int)((new HTuple(hv_AnomalyRegionThreshold.TupleNotEqual(-1))).TupleOr(
                            new HTuple(((hv_ResultKeys.TupleFind("anomaly_region" + hv_AnomalyResultPostfix))).TupleNotEqual(
                            -1)))) != 0)
                        {
                        ...
                        if ((int)(hv_ShowLegend) != 0)
                        {
                            ...
                            if ((int)((new HTuple(hv_AnomalyRegionThreshold.TupleEqual(-1))).TupleAnd(
                                new HTuple(((hv_ResultKeys.TupleFind("anomaly_region" + hv_AnomalyResultPostfix))).TupleEqual(
                                -1)))) != 0)
                            {
                                if (hv_Text == null)
                                    hv_Text = new HTuple();
                        ...
                        hv_KeyIndex))).TupleEqual("anomaly_result_global")))) != 0)
                    {
                        ...
                        if ((int)((new HTuple(hv_AnomalyRegionThreshold.TupleNotEqual(-1))).TupleOr(
                            new HTuple(((hv_ResultKeys.TupleFind(hv_AnomalyRegionKey))).TupleNotEqual(
                            -1)))) != 0)
                        {
                            dev_display_result_anomaly_regions(ho_AnomalyRegion, hv_CurrentWindowHandle,
                                hv_LineWidth, hv_AnomalyRegionResultColor);
                        ...
                        if ((int)(hv_ShowLegend) != 0)
                        {
                            ...
                            if ((int)((new HTuple(hv_AnomalyRegionThreshold.TupleEqual(-1))).TupleAnd(
                                new HTuple(((hv_ResultKeys.TupleFind(hv_AnomalyRegionKey))).TupleEqual(
                                -1)))) != 0)
                            {
                                if (hv_Text == null)
                                    hv_Text = new HTuple();
                        ...
                        hv_KeyIndex))).TupleEqual("bbox_both"))) != 0)
                    {
                        //
                        ...
                        hv_KeyIndex))).TupleEqual("bbox_ground_truth"))) != 0)
                    {
                        //
                        ...
                        hv_KeyIndex))).TupleEqual("bbox_result"))) != 0)
                    {
                        //
                        ...
                        hv_KeyIndex))).TupleEqual("ocr_recognition_both")))) != 0)
                    {
                        ...
                        {
                            hv_CurrentWindowHandle.Dispose(); hv_WindowImageRatio.Dispose(); HTuple ExpTmpOutVar_0;
                            get_next_window(hv_Font, hv_FontSize, hv_NumLines * hv_ShowBottomDesc, hv_WidthImage,
                                hv_HeightImage, 0, hv_ScaleWindows, hv_ThresholdWidth, hv_PrevWindowCoordinates,
                                hv_WindowHandleDict, hv_KeysForDisplay_COPY_INP_TMP.TupleSelect(hv_KeyIndex),
                                out hv_CurrentWindowHandle, out hv_WindowImageRatio, out ExpTmpOutVar_0);
                            hv_PrevWindowCoordinates.Dispose();
                        ...
                        if ((int)(hv_ShowBottomDesc) != 0)
                        {
                            ...
                            if ((int)(hv_ShowResult) != 0)
                            {
                                ...
                                if ((int)(hv_GTWordKeyExists) != 0)
                                {
                                    ...
                                    if ((int)(((hv_DLResult.TupleConcat(hv_DLSample))).TupleTestEqualDictItem(
                                        (new HTuple("word")).TupleConcat("word"))) != 0)
                                    {
                                ...
                                if (hv_Text == null)
                                    hv_Text = new HTuple();
                                hv_Text[new HTuple(hv_Text.TupleLength())] = ((("Deep OCR:" + hv_Spaces) + " \"") + (hv_DLResult.TupleGetDictTuple(
                                    "word"))) + "\"";
                            }
                            if (HDevWindowStack.IsOpen())
                            {
                        ...
                        hv_KeyIndex))).TupleEqual("segmentation_confidence_map"))) != 0)
                    {
                        ...
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            ...
                            get_next_window(hv_Font, hv_FontSize, hv_ShowBottomDesc, hv_WidthImage,
                                ...
                                hv_PrevWindowCoordinates, hv_WindowHandleDict, hv_KeysForDisplay_COPY_INP_TMP.TupleSelect(
            ...
            out HTuple hv_BboxClassIndices)
        {
            ...
            HTuple hv_HeadSize = new HTuple(), hv_MaskRow = new HTuple();
